...
class InsertViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    @IBAction func apply(_ sender: Any) {
        let url = URL(string: "https://www.metaweather.com/api/location/search/?query=" + insertCityName.text!)!
    ...
    @IBAction func currentLocationTapped(_ sender: Any) {
        let uriWithCoordinates = String(format: "https://www.metaweather.com/api/location/search/?lattlong=%2f,%2f", self.coordinates.latitude, self.coordinates.longitude)
    ...
    func findCurrentLocationName() {
        let bingUriWithCoordinates = String(format: "https://dev.virtualearth.net/REST/v1/Locations/%5f,%5f?key=AnXCIDfyDmdeWhsmlUUIos9mDWM2bMqFFDw8r_9VZUeqXk11LuWOy7dE357jvjqx", self.coordinates.latitude, self.coordinates.longitude)
    ...
    func updateCurrentLocation(currentLocation: String) {
        self.currentLocation.text = "This is where you are: " + currentLocation
    }
}
